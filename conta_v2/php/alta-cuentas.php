		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<div class="row">
					...
					<div class="col-lg-12 well">
						<form action="agregar-cuentas.php" class="form-horizontal" method="post" name="crear_clase_frm" enctype="application/x-www-form-urlencoded">
							<fieldset>
								...
								<div class="container">
									<div class="row">
										...
										<div class="col-lg-6">
											...
											<!--<select name="clase_slc" id="clase" class="form-control" required>
									...
									<div class="row">
										<div class="col-lg-12">
											<label for="nombre_clase" class="control-label">Nombre</label>
											<input type="text" id="nombre_clase" name="nombre_clase" class="form-control" title="Escriba un nombre para la clase" placeholder="Escriba el nombre asignado a la clase" required/>
										</div>
									</div>
									<br>
									<div class="row">
										<div class="col-lg-12">
											<button class="btn btn-success pull-right" type="submit"><span class="glyphicon glyphicon-save"></span>&nbsp; Guardar Clase</button>
										</div>
									</div>
								</div>
							</fieldset>
					...
					<div class="col-lg-12 well">
						<form action="agregar-cuentas.php" class="form-horizontal" method="post" name="crear_subcuenta_frm" enctype="application/x-www-form-urlencoded">
							<fieldset>
								...
								<div class="container">
									<div class="row">
										<input type="hidden" value="5" name="tipo_hdn"/>
										<div class="col-lg-4">
