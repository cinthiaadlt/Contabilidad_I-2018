		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				<div class="page-header">
					<h3>Asiento General-Ingresos y Egresos</h3>
				</div>
				<div class="row">
					...
					<!--
						...
						<p align="justify" class="text-info">
							Un asiento general se realiza cuando se va a registrar una salida o entrada de dinero para una única cuenta. Debe tener el cuidado de insertar correctamente las cantidades en el debe y el haber, de acuerdo al tipo de cuenta. 
							Para cumplir con partida doble, deberá generar otro asiento en el que se vea afectada la otra cuenta. Asigne el mismo número de asiento a las transacciones que estén relacionadas entre sí, o las que se complementen con partida doble.
						</p>
					</div>
					<hr>
					<div>
						<?php 
							...
							if($num_regs>0){
								...
								echo "La ultima ficha registrada es: <strong>".$ult_asiento."</strong>";
								echo "</div>";
							}
							...
							<fieldset>
								<div class="container">
									...
									<div class="row">
										...
										<div class="col-lg-2">
											<label for="n_asiento" class="control-label">N° de ficha</label>
											<input type="number" min="1" class="form-control" id="n_asiento" name="n_asiento_txt" placeholder="Ficha N°" title="Escriba el número de asiento a registrar" required/>
										</div>
										<div class="col-lg-4">
											<label for="fecha" class="control-label">Fecha</label>
                                            <?php $hoy = date('Y-m-d'); ?>
											<input type="date" class="form-control" id="fecha" name="fecha_txt" title="Ingrese la fecha de la ficha" value=<?php echo $hoy;?> >
										</div>
                                        <div class="col-lg-2">
                                            <label for="hora" class="control-label">Hora</label>
                                            <?php $time = date('H:i'); ?>
                                            <input type="time" class="form-control" disabled="true" id="hora" name="hora_txt" title="Ingrese la hora de la ficha" value=<?php echo $time;?> >
                                        </div>
									</div>
									<div class="row">
										<div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6" id="div-subcuentas">
                                            ...
                                            <option >Seleccione Subcuenta</option>
                                            </select>
                                        </div>
									</div>
									<div class="row">
