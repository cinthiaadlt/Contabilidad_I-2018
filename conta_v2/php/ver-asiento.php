								...
								<div class="container">
									...
									<div class="row">
										...
										<div class="col-lg-2">
											...
											<input type="text" min="1" class="form-control" id="n_asiento" name="n_asiento_txt" placeholder="Ficha N°" title="Número de asiento registrado" value='<?php echo $registro["transaccion"]; ?>' disabled required/>
										</div>
										<div class="col-lg-4">
