	...
	if($num_regs!=0){
		...
		/* Si el usuario no ingresó una subcuenta, verificamos que la cuenta ingresada no posea subcuentas. */
			...
			/*Si existen subcuentas relacionadas a la cuenta ingresada, solicitamos al usuario que indique una subcuenta. */
                ...
                echo "<script> setTimeout(function() { window.location = 'asiento-general.php?error=subcuenta'; }, 2000); </script>";
			}
        ...
        echo "<script> setTimeout(function() { window.location = 'asiento-general.php?error=anio'; }, 2000); </script>";
		}

	} else {
    echo "<script> setTimeout(function() { window.location = 'asiento-general.php?error=fecha-invalida'; }, 2000); </script>";
	}
