        		...
        		<div class="row">
                    ...
                    <!--
                        ...
                        <p align="justify" class="text-info">
                            Si desea eliminar el perfil de alguno de los usuarios del sistema, selecciónelo en la lista que aparece abajo. Deberá proporcionar su contraseña para asegurar de que usted quiere realizar la operación de eliminación. Recuerde que usted no puede eliminar su propia cuenta.
                        </p>
                    </div>
                    <hr>
        			<div class="col-md-6">
