        		...
        		<div class="row">
        			<div class="col-md-12 well">
        				<div class="alert alert-danger text-center">
        					<strong>Aviso importante:</strong> <br>Este sistema ha sido diseñado para ser visualizado en los navegadores Google Chrome, Mozilla Firefox, Opera, Safari y Maxthon. Recomendamos encarecidamente no usar Microsoft Internet Explorer.
        					<!--
        					 <a href="compatibilidad.php">Detalles.</a>
        					 -->
        				</div>
        				<!--
        				<p align="justify">
