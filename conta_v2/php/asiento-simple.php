		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				<div class="page-header">
					<h3>Asiento simple-Inversiones</h3>
				</div>
				<div class="row">
							...
							<fieldset>
								<div class="container">
									<div class="row">
										...
										<div class="col-md-2">
											<label for="asiento" class="control-label">N° de ficha</label>
											<input type="number" min="1" id="asiento" class="form-control" name="asiento_txt" placeholder="Ficha N°" title="Escriba el número de asiento" required/>
										</div>
										<div class="col-md-4">
